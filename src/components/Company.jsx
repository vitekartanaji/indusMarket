            ...
            <div class="grid md:grid-cols-2">
              <div class="h-full pr-6">
                <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                  Indus Global Markets Limited is a global forex broker founded
                  by an expert team to offer world-class trading conditions to
                  amateur and professional traders. Utilizing cutting-edge
                  technology and infrastructure, we provide favorable trading
                  conditions to help you grow.
                </p>
                  ...
                  <li class="flex">
                    ...
                    <div class="ml-4 mb-4">
                      ...
                      <p class="text-gray-600 dark:text-slate-400">
                        4004, U-Bora Tower, Business Bay
                      </p>
                      <p class="text-gray-600 dark:text-slate-400">
                        Dubai, UAE
                      </p>
